...
function Home() {
  ...
  useEffect(() => {
    ...
    fetchProfile(); // ✅ Fetch the latest profile data
        ...
        <div className="space-y-6">
          {posts.map((post) => (
            <div key={post.id} className="border p-4 rounded-lg shadow-md bg-white">
              ...
              {/* ✅ Display Updated Name & Occupation */}
              <h3 className="text-lg font-bold">{profile.fullName} - <span className="text-gray-600">{profile.occupation}</span></h3>
